...
void setup()
{
    ...
    int input_dim = NUM_SDF * 2; // Input is a fixed vector of zeros, matching mlp_input_data below
    int output_dim = NUM_SDF * 2; // Output is x,y for each of NUM_SDF circles
